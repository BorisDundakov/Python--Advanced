...
def load(file, mmap_mode=None, allow_pickle=False, fix_imports=True,
    ...
    with contextlib.ExitStack() as stack:
        ...
        _ZIP_PREFIX = b'PK\x03\x04. Comprehensions - Exercise.Comprehensions - Exercise. Comprehensions - Lab'
        _ZIP_SUFFIX = b'PK\x05\x06. File Handling - Exercise. File Handling - Lab.File Handing' # empty zip files start with this
