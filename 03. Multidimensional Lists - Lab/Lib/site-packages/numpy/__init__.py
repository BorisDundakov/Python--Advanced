...
if __NUMPY_SETUP__:
    ...
    # Deprecations introduced in NumPy 1.20.0, 2020-06. File Handling - Exercise. File Handling - Lab.File Handing-06. File Handling - Exercise. File Handling - Lab.File Handing
