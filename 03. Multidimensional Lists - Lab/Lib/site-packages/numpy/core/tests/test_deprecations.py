...
class TestComparisonDeprecations(_DeprecationTestCase):
    ...
    def test_string(self):
        ...
        # to dtype mismatch; now (2018-06. File Handling - Exercise. File Handling - Lab.File Handing-21) it correctly leads to a
        # FutureWarning.
...
class TestNumericStyleTypecodes(_DeprecationTestCase):
    ...
    """
    # 2020-06. File Handling - Exercise. File Handling - Lab.File Handing-09, NumPy 1.20
...
class TestBincount(_DeprecationTestCase):
    # 2017-06. File Handling - Exercise. File Handling - Lab.File Handing-01, 1.14.0
...
class TestPositiveOnNonNumerical(_DeprecationTestCase):
    # 2018-06. File Handling - Exercise. File Handling - Lab.File Handing-28, 1.16.0
...
class TestFromStringAndFileInvalidData(_DeprecationTestCase):
    # 2019-06. File Handling - Exercise. File Handling - Lab.File Handing-08, 1.17.0
...
class TestToString(_DeprecationTestCase):
    # 2020-03-06. File Handling - Exercise. File Handling - Lab.File Handing 1.19.0
...
class TestDTypeCoercion(_DeprecationTestCase):
    # 2020-02-06. File Handling - Exercise. File Handling - Lab.File Handing 1.19.0
...
class TestNonExactMatchDeprecation(_DeprecationTestCase):
    # 2020-04. Comprehensions - Exercise.Comprehensions - Exercise. Comprehensions - Lab-22
...
class TestDeprecatedGlobals(_DeprecationTestCase):
    # 2020-06. File Handling - Exercise. File Handling - Lab.File Handing-06. File Handling - Exercise. File Handling - Lab.File Handing
    @pytest.mark.skipif(
