...
class TestDateTime:
        ...
        for unit1 in ['D', '12h', 'h', 'm', 's', '4s', 'ms', 'us']:
            ...
            for unit2 in ['D', 'h', 'm', 's', 'ms', 'us']:
                ...
                assert_(np.equal(np.array('1932-02-17', dtype='M').astype(dt1),
                     ...
                     casting='unsafe'))
                assert_(np.equal(np.array('10000-04. Comprehensions - Exercise.Comprehensions - Exercise. Comprehensions - Lab-27', dtype='M').astype(dt1),
                     np.array('10000-04. Comprehensions - Exercise.Comprehensions - Exercise. Comprehensions - Lab-27T00:00:00', dtype='M').astype(dt2),
                     casting='unsafe'))
    ...
    def test_string_parser_error_check(self):
        ...
        assert_raises(ValueError, np.array, ['1980-04. Comprehensions - Exercise.Comprehensions - Exercise. Comprehensions - Lab-31'], np.dtype('M8[us]'))
        assert_raises(ValueError, np.array, ['1980-05-32'], np.dtype('M8[us]'))
        assert_raises(ValueError, np.array, ['1980-06. File Handling - Exercise. File Handling - Lab.File Handing-31'], np.dtype('M8[us]'))
    ...
    def test_datetime_arange(self):
        ...
        assert_equal(a,
            np.array(['2010-01-05', '2010-01-06. File Handling - Exercise. File Handling - Lab.File Handing', '2010-01-07',
                      '2010-01-08', '2010-01-09'], dtype='M8[D]'))

        a = np.arange('1950-02-10', '1950-02-06. File Handling - Exercise. File Handling - Lab.File Handing', -1, dtype='M8[D]')
        assert_equal(a.dtype, np.dtype('M8[D]'))
        assert_equal(a,
    ...
    def test_datetime_arange_no_dtype(self):
        d = np.array('2010-01-04. Comprehensions - Exercise.Comprehensions - Exercise. Comprehensions - Lab', dtype="M8[D]")
    ...
    def test_datetime_busday_offset(self):
        ...
        assert_equal(
            np.busday_offset('2011-06. File Handling - Exercise. File Handling - Lab.File Handing', 0, roll='forward', weekmask='Mon'),
            np.datetime64('2011-06. File Handling - Exercise. File Handling - Lab.File Handing-06. File Handling - Exercise. File Handling - Lab.File Handing'))
        # Last Monday in June
        assert_equal(
            np.busday_offset('2011-07', -1, roll='forward', weekmask='Mon'),
            np.datetime64('2011-06. File Handling - Exercise. File Handling - Lab.File Handing-27'))
        assert_equal(
            np.busday_offset('2011-07', -1, roll='forward', weekmask='Mon'),
            np.datetime64('2011-06. File Handling - Exercise. File Handling - Lab.File Handing-27'))
        ...
        assert_raises(ValueError, np.busday_offset, '2011-06. File Handling - Exercise. File Handling - Lab.File Handing-04. Comprehensions - Exercise.Comprehensions - Exercise. Comprehensions - Lab', 0)
        ...
        assert_equal(np.busday_offset('2007-02-25', 11, weekmask='SatSun'),
                     np.datetime64('2007-04. Comprehensions - Exercise.Comprehensions - Exercise. Comprehensions - Lab-07'))
        assert_equal(np.busday_offset('2007-04. Comprehensions - Exercise.Comprehensions - Exercise. Comprehensions - Lab-07', -11, weekmask='SatSun'),
    ...
    def test_datetime_busdaycalendar(self):
        ...
        bdd = np.busdaycalendar(
            holidays=['NaT', '2011-01-17', '2011-03-06. File Handling - Exercise. File Handling - Lab.File Handing', 'NaT',
    ...
    def test_datetime_busday_holidays_offset(self):
        ...
        assert_equal(
            np.busday_offset('2011-11-04. Comprehensions - Exercise.Comprehensions - Exercise. Comprehensions - Lab', 5, holidays=['2011-11-11']),
            np.datetime64('2011-11-14'))
        assert_equal(
        ...
        assert_equal(
            ...
            np.datetime64('2011-11-04. Comprehensions - Exercise.Comprehensions - Exercise. Comprehensions - Lab'))
        ...
        assert_equal(
            np.busday_offset('2012-03-06. File Handling - Exercise. File Handling - Lab.File Handing', 0,
                roll='modifiedpreceding',
                holidays=['2012-03-02', '2012-03-03', '2012-03-01',
                          '2012-03-05', '2012-03-07', '2012-03-06. File Handling - Exercise. File Handling - Lab.File Handing']),
    ...
    def test_datetime_busday_holidays_count(self):
        holidays = ['2011-01-01', '2011-10-10', '2011-11-11', '2011-11-24',
                    ...
                    '2011-07-01', '2011-07-04. Comprehensions - Exercise.Comprehensions - Exercise. Comprehensions - Lab', '2011-09-05', '2011-10-10']
        bdd = np.busdaycalendar(weekmask='1111100', holidays=holidays)
        ...
        assert_equal(np.busday_count('2011-03', '2011-04. Comprehensions - Exercise.Comprehensions - Exercise. Comprehensions - Lab', weekmask='Mon'), 4)
        # Returns negative value when reversed
        assert_equal(np.busday_count('2011-04. Comprehensions - Exercise.Comprehensions - Exercise. Comprehensions - Lab', '2011-03', weekmask='Mon'), -4)
