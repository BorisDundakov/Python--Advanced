...
class TestRegression:
    ...
    def test_dtype_scalar_squeeze(self):
        ...
        values = {
            'S': b"a",
            'M': "2018-06. File Handling - Exercise. File Handling - Lab.File Handing-20",
        }
    ...
    def test_pickle_datetime64_array(self):
        ...
        d = np.datetime64('2015-07-04. Comprehensions - Exercise.Comprehensions - Exercise. Comprehensions - Lab 12:59:59.50', 'ns')
        arr = np.array([d])
        for proto in range(2, pickle.HIGHEST_PROTOCOL + 1):
